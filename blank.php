    ...
    <div class="row">
      <div class="col-md-6">
        ...
        <ul class="contact-info">
          <li><i class="fa fa-phone"></i> +216 58 888 302</li>
          <li><i class="fa fa-envelope-o"></i> elctro@exemple.com</li>
          <li><i class="fa fa-map-marker"></i> ISET KL</li>
        </ul>
      </div>
      <div class="col-md-6">
        <div class="section-title">
          <h2 class="title">Formulaire de réclamation</h2>
        </div>
        <form>
          <input class="input" type="text" placeholder="Votre Nom">
          <input class="input" type="email" placeholder="Votre Email">
          <select class="input">
            <option value="" selected disabled>Type de réclamation</option>
          ...
          <textarea class="input" placeholder="Votre Message"></textarea>
