			...
			<div id="top-header">
				<div class="container">
					<ul class="header-links pull-left">
						<li><a href="#"><i class="fa fa-phone"></i> +216 58 888 302</a></li>
						<li><a href="#"><i class="fa fa-envelope-o"></i> electro-master@gmail.com</a></li>
					</ul>
								...
								<div class="dropdown">
									...
									<div class="cart-dropdown">
										...
										<div class="cart-summary">
											...
											<h5>SOUS-TOTAL : 8 950,83 Dinar</h5>
										</div>
										<div class="cart-btns">
											<a href="#">Voir le panier</a>
											<a href="#">Vérifier<i class="fa fa-arrow-circle-right"></i></a>
										</div>
									</div>
								</div>
								<!-- /Cart -->
